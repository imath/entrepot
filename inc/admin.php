...
function entrepot_admin_get_plugin_repositories_list() {
	$repositories = entrepot_get_plugin_repositories_list();

	/**
	 * Filter here to edit the returned plugin repositories into the Add/Plugins screen.
	 *
	 * @since 1.6.0
	 *
	 * @param array $repositories The list of plugin repository objects.
	 */
	return apply_filters( 'entrepot_admin_get_plugin_repositories_list', $repositories );
}
